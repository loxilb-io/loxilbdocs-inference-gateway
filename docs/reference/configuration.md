...
| `mode` (0–6, `4`=fullproxy) | NAT / proxy mode | [Configuration Reference §2](../ai-gateway/configuration-reference.md#2-selection-algorithm-sel-and-mode-mode-enums) · [Running Modes](../concepts/running-modes.md) |
| `security` (0–3) | TLS posture | [Configuration Reference §8](../ai-gateway/configuration-reference.md#8-tls-mtls) · [mTLS](../security/mtls.md) |
...
| `kvExactMode`, `kvBlockSize`, `kvHashAlgo`, `kvZmqPort`, `kvWarmupSec`, `kvEngineType`, `kvDpRankCount` | KV-cache exact routing | [Configuration Reference §4](../ai-gateway/configuration-reference.md#4-kv-cache-exact-routing) · [KV-Cache Routing](../ai-gateway/kv-caching.md) |
...
- [swagger-extras (raw)](swagger-extras.md) — raw-middleware endpoints (KV inventory, OPA watcher).
